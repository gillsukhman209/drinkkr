...
struct OnboardingMotivationView: View {
    ...
    var body: some View {
        VStack(spacing: isCompact ? 30 : 40) {
            ...
            // Message based on user's data
            VStack(spacing: 20) {
                Text("Here's what you could achieve")
                    .font(.system(size: isCompact ? 24 : 28, weight: .bold))
                    .foregroundColor(.white)
                    .multilineTextAlignment(.center)
                    .opacity(isVisible ? 1.0 : 0.0)
                ...
                VStack(spacing: 16) {
                    achievementItem(
                        icon: "💰",
                        title: "Save money",
                        subtitle: "Up to $\(Int(viewModel.userProfile.estimatedMonthlySavings)) per month",
                    ...
                    achievementItem(
                        icon: "⏰",
                        title: "Reclaim time",
                        subtitle: "Hours each week for things you love",
                    ...
                    achievementItem(
                        icon: "🧠",
                        title: "Clear mind",
                        subtitle: "Better focus and mental clarity",
            ...
            // Community message
            VStack(spacing: 12) {
                Text("Join 10,000+ people who've transformed their lives")
    ...
    private func achievementItem(icon: String, title: String, subtitle: String, color: Color) -> some View {
        HStack(spacing: 15) {
            Text(icon)
                .font(.system(size: isCompact ? 24 : 28))
